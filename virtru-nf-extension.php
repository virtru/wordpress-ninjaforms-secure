...
function add_policy_page() {
    ...
    if(!isset($policy_page_check->ID) && !the_slug_exists($policy_page_name)){
        $policy_page_id = wp_insert_post($policy_page);
    } else {
        $policy_page_id = $policy_page_check->ID;
    }
...
require(VIRTRU_NINJA_FORMS_PATH.'admin/ajax-api.php');
